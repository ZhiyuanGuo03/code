...
install.packages(c("pROC","caret","ggplot2","dplyr","xgboost","ggrepel","RColorBrewer"))
...
2. Open the R script.
3. Run the entire script sequentially.
4. ROC and learning curve plots will be generated automatically.
